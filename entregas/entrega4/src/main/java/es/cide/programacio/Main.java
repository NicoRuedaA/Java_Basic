...
public class Main {
    ...
    public static int getNumeroInsultos() {
        return arrayInsultos[0].length;
    }
    ...
    public static void main(String[] args) {
        ...
        heroi = new Heroi(heroiNom, VIDA_JUGADOR, arrayInsultos[1]);
        ...
        while (!acabarJuego) {
            ...
            mostrarPanel(heroi.getVida(), 10, illa.vullPirataActual().getNom(), illa.vullPirataActual().getVida(),
                    illa.vullPirataActual().getVidaMax(), heroi.getNom());

            sprites(); // mostramos sprites
